...
// Create
func (s *CategoriesService) Create(ctx context.Context, req *dto.CreateCategoriesRequest) (*dto.CategoriesResponse, error) {
...
// Get By Filter
func (s *CategoriesService) GetByFilter(ctx context.Context, req *dto.PaginationInputWithFilter) (*dto.PagedList[dto.CategoriesResponse], error) {
	return s.base.GetByFilter(ctx, req)
}

// Get By Filter
func (s *CategoriesService) GetAll(ctx context.Context, req *dto.PaginationInputWithFilter) (*dto.PagedList[dto.CategoriesResponse], error) {
	return s.base.GetByFilter(ctx, req)
}
